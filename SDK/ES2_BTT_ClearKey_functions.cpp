...
#include "ES2_BTT_ClearKey_parameters.hpp"
...
void UBTT_ClearKey_C::ReceiveExecute(class AActor** OwnerActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function BTT_ClearKey.BTT_ClearKey_C.ReceiveExecute");

	UBTT_ClearKey_C_ReceiveExecute_Params params;
