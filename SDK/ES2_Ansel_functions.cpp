...
#include "ES2_Ansel_parameters.hpp"
...
void UAnselFunctionLibrary::STATIC_ConstrainCameraByGeometry(class UObject** WorldContextObject, struct FVector* NewCameraLocation, struct FVector* PreviousCameraLocation, struct FVector* OriginalCameraLocation, struct FVector* OutCameraLocation)
{
...
void UAnselFunctionLibrary::STATIC_ConstrainCameraByDistance(class UObject** WorldContextObject, struct FVector* NewCameraLocation, struct FVector* PreviousCameraLocation, struct FVector* OriginalCameraLocation, float* MaxDistance, struct FVector* OutCameraLocation)
{
