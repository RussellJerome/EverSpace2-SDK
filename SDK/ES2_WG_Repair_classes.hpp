...
#include "ES2_WG_Repair_structs.hpp"
...
// WidgetBlueprintGeneratedClass WG_Repair.WG_Repair_C
// 0x00AC (0x02DC - 0x0230)
class UWG_Repair_C : public UUserWidget
{
public:
	...
	class UWG_MenuAction_Button_C*                     Button_Repair;                                            // 0x0240(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	class UWG_MenuAction_Button_C*                     Button_RepairAll;                                         // 0x0248(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	TArray<class UWG_Refill_Ammo_Row_C*>               RepairRows;                                               // 0x0288(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	float                                              HullHitpointsPerPercent;                                  // 0x02D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WG_Repair.WG_Repair_C");
		return ptr;
	}
	...
	void UpdateRows();
	void AddRowEntry(class UWG_Refill_Ammo_Row_C** Widget);
	void CloseWidget(bool* HasRepaired);
	void ExecuteUbergraph_WG_Repair(int* EntryPoint);
	void OnClose__DelegateSignature(bool* HasRepaired);
};
