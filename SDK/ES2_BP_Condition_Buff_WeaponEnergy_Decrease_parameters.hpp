...
#include "ES2_BP_Condition_Buff_WeaponEnergy_Decrease_classes.hpp"
...
struct UBP_Condition_Buff_WeaponEnergy_Decrease_C_CalcIntensity_Params
{
...
struct UBP_Condition_Buff_WeaponEnergy_Decrease_C_OnTokenCountChanged_Params
{
...
struct UBP_Condition_Buff_WeaponEnergy_Decrease_C_ReceiveEndPlay_Params
{
...
struct UBP_Condition_Buff_WeaponEnergy_Decrease_C_InitCondition_Params
{
	class AActor**                                     Instigator;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	int*                                               InstigatorLevel;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UBP_Condition_Buff_WeaponEnergy_Decrease_C_ExecuteUbergraph_BP_Condition_Buff_WeaponEnergy_Decrease_Params
{
